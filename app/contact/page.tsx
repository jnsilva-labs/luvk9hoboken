...
export default function ContactPage() {
  return (
    <>
      ...
      {/* Contact Form + Quick Contact (form first!) */}
      <section className="py-16 md:py-24 px-6 bg-obsidian">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            {/* Quick Contact Info — takes 2/5 */}
            <div className="lg:col-span-2">
              <ScrollReveal delay={0.1}>
                <div className="lg:sticky lg:top-24">
                  <SectionLabel>Quick Contact</SectionLabel>
                  <h2 className="font-display text-2xl md:text-3xl font-bold text-text-title mt-3 mb-6">
                    Or Reach Us Directly
                  </h2>
                  <p className="font-body text-text-body mb-8">
                    Prefer to text or call? We&rsquo;re always happy to chat.
                  </p>
                  ...
                  <div className="space-y-5">
                    ...
                    <a href={`mailto:${business.email}`} className="flex items-center gap-4 group">
                      ...
                      <div>
                        ...
                        <p className="font-body text-sm text-text-body">Send us an email</p>
                      </div>
                    </a>
                    ...
                    <a href={business.instagramUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                      ...
                      <div>
                        ...
                        <p className="font-body text-sm text-text-body">Follow us on Instagram</p>
                      </div>
                    </a>
                  </div>

                  {/* Business Hours */}
                  <div className="mt-10 bg-imperial/50 border border-gold/10 rounded-2xl p-6">
                    <h3 className="font-display text-lg font-semibold text-text-title mb-4">
                      Business Hours
                    </h3>
