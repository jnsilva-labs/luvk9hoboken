...
// ─── Plain-text answer map for schema.org JSON-LD ───
// Answers with JSX need plain-text equivalents for structured data.
const plainTextAnswers: Record<string, string> = {
  "What is required to enroll in Luv K9 services?":
    "To utilize Luv K9 services, we require a minimum 3-day recurring schedule (Monday through Friday) and a required meet & greet prior to starting services.",
  "Is a meet & greet required before starting?":
    "Yes. All clients must complete a meet & greet prior to starting services so we can meet your pup, review routines and preferences, and go over policies.",
  "Do you require keys or fobs?":
    "Yes. We require two copies of your keys and/or building fobs prior to starting service, regardless of whether your building has a concierge or lockbox.",
  "What vaccinations are required?":
    "All pups must be up to date on Rabies and Bordetella (Kennel Cough). Proof of vaccination is required prior to starting services.",
  "Are dogs required to be spayed or neutered?":
    "Yes. To participate in PlayCare, dogs must be spayed or neutered by 1 year of age. Walk-only dogs are not required to be altered.",
  "Are there size or breed limitations?":
    "Yes. We no longer accept brachycephalic (short-nosed) breeds or dogs under 8 lbs due to safety and health considerations.",
  "What qualifies as a 3-day recurring schedule?":
    "The 3 required days must be one consistent service type — either all dog walks or all PlayCare days.",
  "Can I mix walks and PlayCare?":
    "You may add additional walks to an existing PlayCare schedule, but you may not add PlayCare to a walk-only schedule.",
  "How do I manage my schedule?":
    "All services are managed through our scheduling app, where you can view appointments, see GPS-tracked routes, and receive photos and visit notes.",
  "What is your change and cancellation policy?":
    "Appointments must be added or canceled at least 24 hours in advance. Changes made less than 24 hours before service may result in a fee.",
  "Do you offer weekend or holiday care?":
    "Yes. Weekend and holiday walks, PlayCare, and boarding are available exclusively to current Luv K9 clients. Advance notice is strongly encouraged.",
  "Do you offer a puppy program?":
    "Yes. Our structured puppy program consists of fourteen consecutive days of daycare focusing on crate training, leash etiquette, curbing habits, and safe socialization.",
  "Do you offer dog boarding?":
    "Yes. We offer overnight boarding at our 614 Jefferson location for up to 10 dogs. We advise booking in advance.",
  "What do I need to provide for boarding?":
    "Clients must individually bag and label all food by meal, include medications and vaccination records, and inform us of any medications your dog takes.",
  "Are services held outdoors?":
    "Yes. Luv K9 is an outdoor-based program. We monitor temperature, humidity, wind, rain and snow conditions and are fully equipped with seasonal safety gear.",
  "What happens if the weather turns for the worse during care?":
    "Pups will be safely transported to our Luv Kuts salon or Luv K9 locations to rest until conditions improve or pickup occurs.",
  "What gear is required for my dog?":
    "Clients must provide a winter coat during cold weather, raincoat during wet conditions, and cooling vest during summer months.",
  "Do I need to provide my own leash?":
    "No. All dogs are walked using a Luv K9 uniform leash and safety clip, which we provide.",
  "What if my dog damages the leash or safety clip?":
    "Pet parents are responsible for ensuring their dog does not chew or damage Luv K9 equipment. Damaged or broken leashes or safety clips may result in replacement fees.",
  "How do payments work?":
    "Luv K9 operates on a weekly billing cycle. Clients are invoiced every Friday via PayPal and can pay with credit, debit, Apple Pay, and more.",
};
    ...
    cat.questions.map((q) => ({
      ...
      answer:
        typeof q.answer === "string"
          ? q.answer
          : plainTextAnswers[q.question] ?? q.question,
    }))
  );
}
